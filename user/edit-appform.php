...
<tr>
  <th>Education Qualification</th>
   <th>Schoolname</th>
    <th>Academic Year</th>
     <th>form four Percentage</th>
       <th>RollNumber</th>
</tr>
<tr>
<th>12th(Secondary)</th>
<td>   <input class="form-control white_bg" id="10thboard" name="10thboard" placeholder="Schoolname"  type="text" required='true' value="<?php echo $row['SecondaryBoard'];?>"></td>
<td>   <input class="form-control white_bg" id="10thpyeaer" name="10thpyear" placeholder="Academic Year"  type="text" required='true' value="<?php echo $row['SecondaryBoardyop'];?>"></td>
<td>   <input class="form-control white_bg" id="10thpercentage" name="10thpercentage" placeholder="form four Percentage"  type="text" required='true' value="<?php echo $row['SecondaryBoardper'];?>"></td>
<td>   <input class="form-control white_bg" id="10thstream" name="10thstream" placeholder="RollNumber"  type="text" required='true' value="<?php echo $row['SecondaryBoardstream'];?>"></td>
</tr>

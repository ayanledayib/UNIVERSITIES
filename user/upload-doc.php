...
<tr>
  <th>Nationality Card</th>
  <td><a href="userdocs/<?php echo $row['TransferCertificate'];?>" target="_blank" required>View File </a></td>
</tr>
<tr>
  <th>8th Marksheet</th>
...
<tr>
  ...
  <td><a href="userdocs/<?php echo $row['TwelveMarksheet'];?>" target="_blank" required>View File </a></td>
</tr>
<tr>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Upload Documents --- Only jpg / jpeg/ png /gif/pdf format allowed</h4>
...
<div class="col-xl-4 col-lg-12">
  <fieldset>
  <h5>Volunteer Certificate(if any)                </h5>
   <div class="form-group">

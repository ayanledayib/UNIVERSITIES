...
<tr>
  <th>Education Qualification</th>
   <th>Schoolname</th>
    <th>Academic Year</th>
     <th>Form four Grade</th>
       <th>RollNumber</th>
</tr>
<th>12th(Secondary)</th>
...
if($row['AdminStatus']=="2"){?>
  <form action="delete_adminstatus.php?del=<?php echo $row['UserId']?>" method="post">
    <p class="text-danger">Rejected  <button class="btn btn-primary">Apply Again</button></p>
...
<div class="row" style="margin-top:1%">
  ...
  <h5>Level To Study                  </h5>
   <!-- <div class="form-group"> -->
   <!-- <input class="form-control white_bg" id="coradd" name="coradd"  type="text" required> -->
   <select class="form-control white_bg" id="coradd" name="coradd"  required>
...
<tr>
<th>12th(Secondary)</th>
<td>   <input class="form-control white_bg" id="10thboard" name="10thboard" placeholder="Schoolname"  type="text" required></td>
<td>   <input class="form-control white_bg" id="10thpyeaer" name="10thpyear" placeholder=" Graduation Year"  type="text" required></td>
<td>   <input class="form-control white_bg" id="10thpercentage" name="10thpercentage" placeholder="Form Four Grade"  type="text" required></td>
<td>   <input class="form-control white_bg" id="10thstream" name="10thstream" placeholder="RollNumber"  type="text" required></td>
</tr>

...
if(isset($_POST['submit']))
  {
    ...
    $AName=$_POST['adminname'];
     ...
     $query=mysqli_query($con, "update tbluniversity set AdminName ='$AName' where ID='$adminid'");
    if ($query) {
...
<form name="submit" method="post" enctype="multipart/form-data"> 
  <?php
$adminid=$_SESSION['aid'];
$ret=mysqli_query($con,"select * from tbluniversity where ID='$adminid'");
$cnt=1;
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Eelo Admin Profile</h4>

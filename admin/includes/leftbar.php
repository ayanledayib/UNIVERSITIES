...
<li class=" nav-item"><a href="search-application.php"><i class="la la-search"></i><span class="menu-title" data-i18n="nav.dash.main">Search Application</span></a>
        ...
        <li class=" nav-item"><a href="university-admins.php"><i class="la la-users"></i><span class="menu-title" data-i18n="nav.dash.main">University Admins</span></a>
        </li>
  

<li class=" nav-item"><a href="#"><i class="la la-file"></i><span class="menu-title" data-i18n="nav.footers.main">Universities</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="add-course.php" data-i18n="nav.footers.footer_light">Add University</a>
            </li>
            <li><a class="menu-item" href="manage-course.php" data-i18n="nav.footers.footer_dark">Manage University</a>
            </li>
          </ul>
        </li>
...
<!-- <li class=" nav-item"><a href="#"><i class="la la-download"></i><span class="menu-title" data-i18n="nav.footers.main">Public Notice</span></a> 
          <ul class="menu-content">
            <li><a class="menu-item" href="add-notice.php" data-i18n="nav.footers.footer_light">University Admins</a>
            </li>

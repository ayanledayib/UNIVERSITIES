...
<tr>
  ...
  <td><a href="../user/userdocs/<?php echo $row['TransferCertificate'];?>" target="_blank" required>View File </a></td>
</tr>
<tr>
  <th>8th Certificate</th>
  <td><a href="../user/userdocs/<?php echo $row['TenMarksheeet'];?>" target="_blank" required>View File </a></td>
</tr>
<tr>
  <th>12th Certificate</th>
  <td><a href="../user/userdocs/<?php echo $row['TwelveMarksheet'];?>" target="_blank" required>View File </a></td>
</tr>
<tr>

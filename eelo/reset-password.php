...
$query=mysqli_query($con,"update tbluniversity set Password ='$newpassword' where  Email='$email' && MobileNumber = $mobno ");
...
data-open="click" data-menu="vertical-menu" data-col="1-column">
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; <?php echo date('Y');?> <a class="text-bold-800 grey darken-2" >EU </a>, All rights reserved. </span>
